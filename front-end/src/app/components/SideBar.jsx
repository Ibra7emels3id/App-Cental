...
import BtnAccountSidebar from './BtnAccountSidebar';
...
const SideBar = ({ showSidebar, handleToggle }) => {
    ...
    return (
        <nav className={`${showSidebar ? "left-0 opacity-100" : "-left-[30%] opacity-0 pointer-events-none"} transition-all duration-500 bg-[#f7f7f8] min-h-screen fixed top-0  min-w-[260px] py-6 px-4 font-[sans-serif] flex flex-col overflow-auto z-50`}>
            <Link href="/" className="">
                <h1 className='flex items-center text-color_red font-bold text-4xl'>
            ...
            <ul className="space-y-3 flex-1 mt-10">
                ...
                <li>
                    <Link
                        href="/service"
                        className="text-black hover:text-[#077fbb] text-xl flex items-center hover:bg-gray-200 rounded px-4 py-3 transition-all relative"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
