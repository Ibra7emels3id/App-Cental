...
const Team = () => {
    return (
        <div className="font-[sans-serif] max-w-7xl max-lg:max-w-4xl  max-sm:max-w-sm mx-auto mt-4 py-16">
            <div className="max-w-2xl mx-auto text-center">
                <h2 className="text-gray-800 text-5xl font-extrabold">Customer <span className='text-color_red'>Support</span> Center</h2>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-6 gap-y-16 text-center mt-24">
                <div className="bg-gray-100 relative rounded">
                    <Image
                        ...
                        className="w-52 h-58 rounded inline-block -mt-12"
                        alt="Team Member 1"
                        width={100}
                        height={100}
                    />
