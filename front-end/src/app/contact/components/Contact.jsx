...
const Contact = () => {
    return (
        <div className="font-[sans-serif] max-w-6xl mx-auto px-4 py-10 my-5">
            <div className="bg-[#eee] flex flex-col gap-10 p-8">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
                    <div className="flex flex-col items-center bg-white py-5 rounded-xl">
                        <svg
                        ...
                        <div className="mt-4 text-center">
                            <h4 className="text-gray-800 text-sm font-bold">Visit office</h4>
                    ...
                    <div className="flex flex-col items-center bg-white py-5 rounded-xl">
                        ...
                        <div className="mt-4 text-center">
                            <h4 className="text-gray-800 text-sm font-bold">Call us</h4>
                            <p className="text-xs text-gray-500 mt-1"> +158 996 888</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center bg-white py-5 rounded-xl">
                        <svg
                        ...
                        <div className="mt-4 text-center">
                            <h4 className="text-gray-800 text-sm font-bold">Chat to us</h4>
                            <p className="text-xs text-gray-500 mt-1">info@example.com</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center bg-white py-5 rounded-xl">
                        <svg
                        ...
                        <div className="mt-4 text-center">
                            <h4 className="text-gray-800 text-sm font-bold">Fax</h4>
                            <p className="text-xs text-gray-500 mt-1">+1-548-2588</p>
                        </div>
                    </div>
                </div>
                <FormMessage />
